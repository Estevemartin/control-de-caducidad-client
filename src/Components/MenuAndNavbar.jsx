              ...
              <li class="nav-item">
                <div class="search-box" data-list='{"valueNames":["title"]}'>
                  ...
                  <div class="dropdown-menu border font-base left-0 mt-2 py-0 overflow-hidden w-100">
                    <div class="scrollbar list py-3" style={{maxHeight: 24 + 'rem'}}>
            ...
            <div class="card-body overflow-hidden p-lg-6">
              <div class="row align-items-center">
                ...
                <div class="col-lg-6 pl-lg-4 my-5 text-center text-lg-left">
                  ...
                  <a class="btn btn-falcon-primary" href="../documentation/getting-started.html">Create a New Company</a><br/><br/>
                  <a class="btn btn-falcon-primary" href="../documentation/getting-started.html">Add an Existing Company</a>
                </div>
              </div>
            </div>
          </div>
                ...
                <div class="btn-group btn-block btn-group-navbar-style">
                  <div class="row gx-2">
                    <div class="col-6">
                      ...
                      <label class="btn btn-block btn-navbar-style fs--1" for="navbar-style-transparent"> <img class="img-fluid img-prototype" src="../assets/img/generic/default.png" alt="" /><span class="label-text"> Transparent</span></label>
                    </div>
                    <div class="col-6">
                      ...
                      <label class="btn btn-block btn-navbar-style fs--1" for="navbar-style-inverted"> <img class="img-fluid img-prototype" src="../assets/img/generic/inverted.png" alt="" /><span class="label-text"> Inverted</span></label>
                    </div>
                    <div class="col-6">
                      ...
                      <label class="btn btn-block btn-navbar-style fs--1" for="navbar-style-card"> <img class="img-fluid img-prototype" src="../assets/img/generic/card.png" alt="" /><span class="label-text"> Card</span></label>
                    </div>
                    <div class="col-6">
                      ...
                      <label class="btn btn-block btn-navbar-style fs--1" for="navbar-style-vibrant"> <img class="img-fluid img-prototype" src="../assets/img/generic/vibrant.png" alt="" /><span class="label-text"> Vibrant</span></label>
                    </div>
                  </div>
                </div>
