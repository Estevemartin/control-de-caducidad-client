...
export default class UpcomingExpirationsItem extends Component {
  render() {
    return (
      <div
        className="card mb-3"
      ...
      >
            ...
            <div className="col-8 col-sm-auto text-right pl-2">
              ...
              <div id="table-customers-replace-element">
                <button className="btn btn-falcon-default btn-sm" type="button">
                  ...
                  ></span>
                  <span className="d-none d-sm-inline-block ml-1">New</span>
                </button>
                <button
                ...
                >
                  <span
                    ...
                    data-fa-transform="shrink-3 down-2"
                  ></span>
                  <span className="d-none d-sm-inline-block ml-1">Filter</span>
                </button>
                <button className="btn btn-falcon-default btn-sm" type="button">
                  <span
                    ...
                    data-fa-transform="shrink-3 down-2"
                  ></span>
                  <span className="d-none d-sm-inline-block ml-1">Export</span>
                </button>
              </div>
            </div>
          </div>
            ...
            <table className="table table-sm table-striped fs--1 mb-0">
              <thead className="bg-200 text-900">
                <tr>
                  ...
                  <th
                    className="sort pr-1 align-middle white-space-nowrap"
                    data-sort="name"
                  >
                    Name
                  </th>
              ...
              <tbody className="list" id="table-customers-body">
                <tr className="btn-reveal-trigger">
                  ...
                  <td className="name align-middle white-space-nowrap py-2">
                    <a href="../e-commerce/customer-details.html">
                      <div className="d-flex d-flex align-items-center">
                        ...
                        <div className="flex-1">
                          <h5 className="mb-0 fs--1">Employee name</h5>{" "}
                          {/* TODO: db info */}
                        </div>
                      </div>
                    </a>
                  ...
                  <td className="email align-middle py-2">
                    last delivery date {/* TODO: db info */}
                  </td>
                  <td className="phone align-middle white-space-nowrap py-2">
                    Expiry date {/* TODO: db info */}
                  </td>
        ...
        <div className="card-footer d-flex align-items-center justify-content-center">
          <button
            className="btn btn-sm btn-falcon-default mr-1"
            type="button"
            title="Previous"
          ...
          <button
            className="btn btn-sm btn-falcon-default ml-1"
            type="button"
            title="Next"
