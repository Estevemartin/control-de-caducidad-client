                      ...
                      <td className="name align-middle white-space-nowrap py-2"><a href="../e-commerce/customer-details.html">
                          <div className="d-flex d-flex align-items-center">
                            ...
                            <div className="flex-1">
                              <h5 className="mb-0 fs--1">Employee name</h5> {/* TODO: db info */}
                            </div>
                          </div>
                        </a></td>
                      <td className="email align-middle py-2">last delivery date {/* TODO: db info */}</td>
                      <td className="phone align-middle white-space-nowrap py-2">Expiry date {/* TODO: db info */}</td>
