          ...
          <div className="card">
            <div className="card-body p-4 p-sm-5">
              <div className="text-center">
                <img className="d-block mx-auto mb-4" src="../../assets/img/illustrations/envelope.png" alt="Email" width="70" />
                <h4>Please check your email!</h4>
                <p>We sent you an email to {resetOrActivateAcctounMessage()}.</p>
                <Link className="btn btn-primary btn-sm mt-3" to="/"> <span className="fas fa-chevron-left mr-1" data-fa-transform="shrink-4 down-1" ></span> Return to login </Link>
              </div>
            </div>
          </div>
        </div>
