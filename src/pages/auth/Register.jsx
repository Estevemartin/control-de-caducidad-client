                ...
                <div className="container">
                    ...
                    <div className="col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4"><Link className="d-flex flex-center mb-4" to="/"><img className="mr-2" src="../../assets/img/illustrations/rayas.png" alt="logo" width="58" /><span className="font-sans-serif font-weight-bolder fs-5 d-inline-block">MPA Solutions</span></Link>
                        ...
                        <div className="card-body p-4 p-sm-5">
                            ...
                            <div className="col-auto fs--1 text-600"><span className="mb-0 undefined">Have an account?</span> <span><Link to="/login">Login</Link></span></div>
                            </div>
                            <form>
                            <div className="mb-3">
                            ...
                            <div className="form-check">
                                <input className="form-check-input" type="checkbox" id="basic-register-checkbox" />
                                <label className="form-label" for="basic-register-checkbox">I accept the <Link to="#!">terms </Link>and <Link to="#!">privacy policy</Link></label>
                            </div>
                            <div className="mb-3">
